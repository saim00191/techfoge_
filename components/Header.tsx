...
//       <div className="text-white container  flex items-center justify-between py-2  relative z-50">
//         {/* Logo */}
//         <Image src={Logo} alt="Logo" className="h-24 w-[140px]" />
...
//               <Link
//                 href={item.href}
//                 className="hover:text-[#00D1FF] transition-colors duration-300"
//               >
//                 {item.name}
...
//         >
//           <span
//             className={`h-[2px] w-full bg-[#00D1FF] transform transition duration-300 ease-in-out ${
//               isOpen ? "rotate-45 translate-y-[9px]" : ""
//             }`}
//           />
//           <span
//             className={`h-[2px] w-full bg-[#00D1FF] transition duration-300 ease-in-out ${
//               isOpen ? "opacity-0" : ""
//             }`}
//           />
//           <span
...
//       <div
//         className={`mdl:hidden fixed top-0 left-0 w-full h-screen bg-[#020A15]/95 backdrop-blur-sm flex flex-col items-center justify-center gap-8 z-40 transform transition-all duration-500 ease-in-out ${
//           isOpen
...
//               <Link
//                 href={item.href}
//                 className="hover:text-[#00D1FF] transition duration-300"
...
//               <button className="mt-4 xsm:hidden px-6 py-2 rounded-full border w-full border-[#00D1FF] text-white font-semibold hover:bg-[#00D1FF33] transition-all duration-300">
//                 Get a Quote
//               </button>
//             </Link>
//           </li>
//         </ul>
//         {/* Social Icons */}
//         <div className="absolute bottom-6 flex items-center gap-5 xs:gap-8 text-[#00D1FF] text-xl">
//           <Link href="https://facebook.com" target="_blank">
//             <FaFacebookF className="hover:scale-125 transition duration-300" />
//           </Link>
//           <Link href="https://instagram.com" target="_blank">
//             <FaInstagram className="hover:scale-125 transition duration-300" />
//           </Link>
//           <Link href="https://linkedin.com" target="_blank">
//             <FaLinkedinIn className="hover:scale-125 transition duration-300" />
//           </Link>
//           <Link href="https://twitter.com" target="_blank">
//             <FaTwitter className="hover:scale-125 transition duration-300" />
//           </Link>
//           <Link href="https://www.threads.net" target="_blank">
//             <FaThreads className="hover:scale-125 transition duration-300" />
//           </Link>
//         </div>
//       </div>
//     </div>
...
//         <ul className="flex flex-col items-center gap-8 text-white text-lg font-medium relative z-10">
...
//               <Link
//                 href={item.href}
//                 className="hover:text-[#00D1FF] transition-all duration-300 hover:scale-110 hover:tracking-wider relative group"
//                 onClick={() => setIsOpen(false)}
//               >
//                 {item.name}
//                 <span className="absolute left-0 -bottom-1 h-[2px] w-full bg-[#00D1FF] transform scale-x-0 origin-center transition-transform duration-300 group-hover:scale-x-100" />
//               </Link>
//             </li>
//           ))}
//           <li
...
//           >
//             <Link href="/quote" onClick={() => setIsOpen(false)}>
//               <button className="mt-4 xsm:hidden px-6 py-2 rounded-full border w-full border-[#00D1FF] text-white font-semibold hover:bg-[#00D1FF33] transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-[#00D1FF]/20 relative overflow-hidden group">
  ...
  return (
    <div className={`bg-[#020A15] ${poppins.className}`}>
      ...
      >
        ...
        {/* Navigation Links with Staggered Animation */}
        <ul className="flex flex-col items-center gap-6 text-white text-lg font-medium relative z-10 max-h-[60vh] overflow-y-auto w-full px-8">
          {navLinks.map((item, index) => (
            <li
              key={item.name}
              ...
              {item.hasDropdown ? (
                <div className="w-full">
                  <button
                    ...
                    className="w-full flex items-center justify-center gap-2 hover:text-[#00D1FF] transition-all duration-300 hover:scale-110 hover:tracking-wider relative group"
                  >
                    {item.name}
                    <FaChevronDown
                      className={`text-xs transition-transform duration-300 ${
                  ...
                  <div
                    className={`mt-4 space-y-3 overflow-hidden transition-all duration-500 ease-in-out ${
                    ...
                    {services.map((service, serviceIndex) => {
                      ...
                      return (
                        <Link
                          key={service.name}
                          href={service.href}
                          className={`flex items-center gap-3 p-3 bg-[#00D1FF]/5 rounded-lg hover:bg-[#00D1FF]/15 transition-all duration-300 hover:scale-105 transform ${
                        ...
                        >
                          <div className="w-8 h-8 bg-[#00D1FF]/20 rounded-lg flex items-center justify-center">
